        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
          <div className="order-2 md:order-1">
            <h2 className="font-headline text-3xl sm:text-4xl font-bold mb-6">
              Somos Mac-Out: Pasión por Apple y por Sevilla
            </h2>
            ...
            <p className="text-muted-foreground leading-relaxed">
              Seleccionamos, verificamos y ponemos a punto cada dispositivo para que disfrutes de la experiencia Apple como si fuera nuevo. Somos tu tienda de confianza en Sevilla, con la garantía y el trato cercano que nos caracteriza.
            </p>
          </div>
