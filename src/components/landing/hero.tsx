...
export function Hero() {
  return (
    <AnimatedSection id="inicio" className="relative h-[80vh] md:h-screen min-h-[500px] w-full text-white">
      ...
      <div className="relative z-10 container mx-auto px-4 flex flex-col justify-end md:justify-center h-full pb-12 md:pb-24">
        <div className="max-w-3xl text-center mx-auto">
          <h1 className="font-headline text-2xl sm:text-5xl lg:text-6xl font-bold tracking-tight">
