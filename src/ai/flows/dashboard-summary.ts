'use server';
/**
 * @fileOverview Summarizes dashboard information for Mac-Out employees.
 *
...
const prompt = ai.definePrompt({
  ...
  prompt: `You are an AI assistant summarizing key business metrics for a Mac-Out employee.
